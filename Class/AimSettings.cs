...
namespace Aimmy2.Class
{
    internal static class AimSettings
    {
        ...
        {
            get => int.Parse(GetDropdown(AILogic.AIManager.ActiveSlot == 1 ? "Slot 1 Image Size" : "Slot 2 Image Size"), CultureInfo.InvariantCulture);
            set => SetDropdown(AILogic.AIManager.ActiveSlot == 1 ? "Slot 1 Image Size" : "Slot 2 Image Size", value.ToString(CultureInfo.InvariantCulture));
        }
